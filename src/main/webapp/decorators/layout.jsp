    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="ftco-nav">
            <ul class="navbar-nav ml-auto">
                <li class="nav-item active"><a href="home" class="nav-link"><fmt:message key="label.home"/></a></li>
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="dropdown04">
                        <a class="dropdown-item" href="?lang=vi"><fmt:message key="label.vi"/></a>
                        <a class="dropdown-item" href="?lang=en"><fmt:message key="label.en"/></a>
                    </div>
                </li>
                <li class="nav-item"><a href="contact" class="nav-link"><fmt:message key="label.contact"/></a></li>
